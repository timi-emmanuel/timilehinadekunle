...
const About = () => {
  return (
    <motion.section
      id="about"
      className="pt-20 pb-12 px-6 md:px-12 lg:px-20 bg-[#0e0e0e] text-light "
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <div className="mx-auto  flex flex-col-reverse md:flex-row-reverse mt-8 gap-6 lg:gap-12">
        ...
        >      
          ...
          <div>
            {/* Stats Section */}
            <div className="flex gap-4 lg:gap-8 mt-8 flex-wrap">
              <div className="flex flex-col items-center justify-center rounded-xl px-2 py-0 ">
